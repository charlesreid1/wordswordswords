...
class EtymologyHTML(object):
    ...
    def export_html_file(self):
        """
        First we load the etymology data container.
        Then we load the loop through each paragraph, 
        """
        ...
        # here we need to add head, body, title and meta tags.
        # wrap new_body in body tags
        # prepend head tags
        #   add title tags
        #   add meta tags
        new_body = ["<html><head><title>" + title + "</title>" + \
                "<meta name=\"author\" content=\"" + self.author + "\" />" + \
                "<meta name=\"save_as\" content=\"" + self.name_ + "\" />" + \
                "</head><body>" ] + new_body + [ "</body></html>" ]
