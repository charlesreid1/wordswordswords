...
logging.basicConfig(filename='dubliners.log',level=logging.DEBUG)

text = '../data/dubliners.txt'
dubliners_html_file = 'gutenberg/dubliners.html'
#dubliners_html_url = 'http://www.gutenberg.org/files/766/766-h/766-h.htm'
...
def gen_html_file(csvfile,htmlfile):
    ...
    #response = browser.open(dubliners_html_url)
    #html_doc = response.read()

    # save/load file locally
    with open(dubliners_html_file,'r') as f:
        html_doc = f.read()
